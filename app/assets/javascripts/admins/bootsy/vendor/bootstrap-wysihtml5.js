  ...
  var tpl = {
    "font-styles": function(locale, options) {
      ...
      return "<li class='dropdown'>" +
        "<a class='btn btn-primary dropdown-toggle" + size + "' data-toggle='dropdown' href='#' title='" + locale.font_styles.title + "'>" +
        ...
        "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h4' tabindex='-1' role='menuitem'>" + locale.font_styles.h4 + "</a></li>" +
        "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h5' tabindex='-1' role='menuitem'>" + locale.font_styles.h5 + "</a></li>" +
        "</ul>" +
      "</li>";
    },
    ...
    "paragraph": function(locale, options) {
      var size = (options && options.size) ? ' btn-'+options.size : '';
      return "<li>" +
        "<a class='btn btn-primary " + size + "' data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='p' tabindex='-1'><i class='fa fa-paragraph'></i></a>" +
      "</li>";
    },
    ...
    "lists": function(locale, options) {
      ...
      return "<li>" +
        "<div class='btn-group'>" +
        "<a class='btn btn-primary " + size + "' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "' tabindex='-1'><i class='fa fa-list'></i></a>" +
        "<a class='btn btn-primary " + size + "' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><i class='fa fa-th-list'></i></a>" +
        "<a class='btn btn-primary " + size + "' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "' tabindex='-1'><i class='fa fa-outdent'></i></a>" +
        "<a class='btn btn-primary " + size + "' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class='fa fa-indent'></i></a>" +
        "</div>" +
      "</li>";
    },
      ...
      return "<li>" +
        ...
        "<div class='modal-dialog'>" +
          ...
          "<div class='modal-footer'>" +
            "<a href='#' class='btn btn-primary' data-dismiss='modal'>" + locale.link.cancel + "</a>" +
            "<a href='#' class='btn btn-primary' data-dismiss='modal'>" + locale.link.insert + "</a>" +
          "</div>" +
          "</div>" +
        "</div>" +
        "</div>" +
        "<a class='btn btn-primary " + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='fa fa-share'></i></a>" +
      "</li>";
    },
    ...
    "image": function(locale, options) {
      ...
      return "<li>" +
        ...
        "<div class='modal-dialog'>" +
          ...
          "</div>" +
          "<div class='modal-footer'>" +
            "<a href='#' class='btn btn-primary ' data-dismiss='modal'>" + locale.image.cancel + "</a>" +
            "<a href='#' class='btn btn-primary' data-dismiss='modal'>" + locale.image.insert + "</a>" +
          "</div>" +
          "</div>" +
        "</div>" +
        "</div>" +
        "<a class='btn btn-primary " + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><i class='fa fa-picture-o'></i></a>" +
      "</li>";
    },
    ...
    "html": function(locale, options) {
      ...
      return "<li>" +
        "<div class='btn-group'>" +
        "<a class='btn btn-primary " + size + "' data-wysihtml5-action='change_view' title='" + locale.html.edit + "' tabindex='-1'><i class='fa fa-pencil'></i></a>" +
        "</div>" +
      "</li>";
    },
    ...
    "color": function(locale, options) {
      var size = (options && options.size) ? ' btn-'+options.size : '';
      return "<li class='dropdown'>" +
        "<a class='btn btn-primary dropdown-toggle" + size + "' data-toggle='dropdown' href='#' tabindex='-1' title='" + locale.colours.title + "'>" +
  ...
  Wysihtml5.prototype = {
    ...
    createToolbar: function(el, options) {
      ...
      toolbar.find("a[data-wysihtml5-command='formatBlock']").click(function(e) {
        var el = $(this);
        if(el.data('wysihtml5CommandValue') !== 'p' ) {
